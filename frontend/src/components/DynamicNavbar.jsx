...
const DynamicNavbar = () => {
    ...
    const fetchUserAndFamilyData = async () => {
        try {
            ...
            const userResponse = await axios.get('https://fullstack-backend-kosy.onrender.com/api/auth/user', {
            ...
            if (userResponse.data && userResponse.data.isAuthenticated) {
                ...
                try {
                    const familyResponse = await axios.get('https://fullstack-backend-kosy.onrender.com/api/familyProfile', {
                        withCredentials: true,
                        timeout: 10000
                    });
    ...
    const fetchNotifications = async () => {
        try {
            const response = await axios.get('https://fullstack-backend-kosy.onrender.com/api/notifications', {
                withCredentials: true,
                timeout: 5000
            });
    ...
    const markNotificationAsRead = async (notificationId) => {
        try {
            await axios.patch(`https://fullstack-backend-kosy.onrender.com/api/notifications/${notificationId}/read`, {}, {
                withCredentials: true
            });
